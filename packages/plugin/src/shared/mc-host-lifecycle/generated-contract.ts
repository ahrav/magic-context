...
export const RELEASE_CONTRACT_SHA256 =
    "a2f7c195f769d369e4495c55806a1645a4ca575cad351b5f2b7a751d83b8eda4";
...
export const releaseContract = {
    cli: {
        ...
        result_schema: "magic-context.daemon/v1",
        states: ["unavailable", "stopped", "starting", "running", "stopping", "wedged"],
    },
    coordination: {
        directory: ".mc-host-coordination",
        lifetime_lock: "lifetime.lock",
    ...
    install_layouts: ["bun_physical_link", "compiled_bun_external", "npm_hoisted", "npm_nested"],
    model_lane: {
        execution_provider: "cpu",
        id: "gte-modernbert-base-f16",
