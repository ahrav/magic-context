...
Generated by `packages/plugin/scripts/export-agent-surface.ts` at 2026-08-27.
...
### ctx_memory — description ~195 tokens, params ~607 tokens (total ~802)
...
```json
{
  ...
  "antiMemory": {
    "description": "Structured rejected-approach payload; valid only with REJECTED_APPROACH",
    "type": "object",
    "properties": {
      "trigger": {
        "type": "string"
...
### ctx_search — description ~340 tokens, params ~226 tokens (total ~566)
