  ...
  return (() => {
        ...
        _$insert(_el$56, (() => {
          ...
          return () => _c$1() ? compactionOffSidebarRows(s()).map(row => _$createComponent(StatRow, {
            ...
            _$insert(_el$63, (() => {
              ...
              return () => _c$11() ? String(s().memoryState) : _$memo(() => (s()?.memoryBlockCount ?? 0) > 0)() ? `${s().memoryBlockCount}/${s()?.memoryCount ?? 0}` : String(s()?.memoryCount ?? 0);
            })());
            _$effect(_p$ => {
    ...
    _$insert(_el$27, (() => {
      ...
      return () => _c$6() && [_$memo(() => _$memo(() => !!(!compactionOff() && sections().historian))() && [(() => {
        ...
        label: "Memories",
        get value() {
          return _$memo(() => !!(s()?.memoryState && s()?.memoryState !== "available"))() ? String(s().memoryState) : String(s()?.memoryCount ?? 0);
        },
        accent: true
