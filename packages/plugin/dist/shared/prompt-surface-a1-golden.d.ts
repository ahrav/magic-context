 ...
 */
export declare const A1_TOOL_SECTION_HEADING = "## 2. Tool surface";
export declare const A1_HASH_BASELINE_HEADING = "## 3. System-prompt hash baseline";
export declare function readA1GoldenDocument(): string;
/**
 ...
 * clean run.
 */
export declare function a1GoldenSectionOffset(document: string, heading: string): number;
//# sourceMappingURL=prompt-surface-a1-golden.d.ts.map