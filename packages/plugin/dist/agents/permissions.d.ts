 ...
 */
export declare function denyTaskRoutingToAgents(permission: unknown, internalAgentIds: readonly string[]): Record<string, unknown>;
/**
 ...
 */
export declare function denyTaskRoutingToCallerAgents(agentConfigs: Record<string, Record<string, unknown>>, internalAgentIds: readonly string[]): Record<string, Record<string, unknown>>;
/**
