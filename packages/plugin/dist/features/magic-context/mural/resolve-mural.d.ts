...
export declare function getMuralCoverage(db: Database, _projectIdentity: string, pool: MuralMemoryPool): MuralCoverage;
/**
 ...
 */
export declare function resolveMural(db: Database, _projectIdentity: string, budgetTokens: number | undefined, pool: MuralMemoryPool): ResolvedMuralEntry[];
//# sourceMappingURL=resolve-mural.d.ts.map