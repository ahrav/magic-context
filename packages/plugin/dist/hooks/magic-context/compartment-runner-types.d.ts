...
import type { BoundarySnapshotValidationResult, ProtectedTailBoundarySnapshot } from "./protected-tail-boundary";
...
export interface CompartmentRunnerDeps {
    ...
    refreshBoundarySnapshot?: (snapshot: ProtectedTailBoundarySnapshot, validation: BoundarySnapshotValidationResult) => ProtectedTailBoundarySnapshot | null;
