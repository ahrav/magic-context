...
export declare const CTX_MEMORY_ACTIONS: readonly ["create", "get", "revise", "archive", "restore", "merge"];
/** Bulk enumeration remains restricted to dreamer maintenance sessions. */
export declare const CTX_MEMORY_DREAMER_ACTIONS: readonly ["create", "get", "revise", "archive", "restore", "merge", "list"];
