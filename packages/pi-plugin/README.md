...
For the full configuration reference (including dreamer, sidekick, auto-search, and experimental features), see [CONFIGURATION.md](https://github.com/ahrav/magic-context/blob/main/CONFIGURATION.md) in the main repository — OpenCode, Pi, and OMP share the same schema.
...
This package is part of the [magic-context monorepo](https://github.com/ahrav/magic-context). Pi and OMP share the same adapter layer and core implementation:
...
For deeper architectural detail, see the main repo's [ARCHITECTURE.md](https://github.com/ahrav/magic-context/blob/main/ARCHITECTURE.md).

---

## License

MIT — see [LICENSE](https://github.com/ahrav/magic-context/blob/main/LICENSE).
