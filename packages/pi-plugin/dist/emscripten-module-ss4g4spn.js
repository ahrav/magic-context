...
// ../../node_modules/.bun/@jitl+quickjs-wasmfile-debug-sync@0.32.0/node_modules/@jitl/quickjs-wasmfile-debug-sync/dist/emscripten-module.mjs
...
`);
  ...
  function assignWasmExports(wasmExports2) {
    ...
    assert(typeof wasmExports2["__funcs_on_exit"] != "undefined", "missing Wasm export: __funcs_on_exit");
    assert(typeof wasmExports2["emscripten_builtin_memalign"] != "undefined", "missing Wasm export: emscripten_builtin_memalign");
    ...
    assert(typeof wasmExports2["__lsan_disable"] != "undefined", "missing Wasm export: __lsan_disable");
    assert(typeof wasmExports2["__lsan_enable"] != "undefined", "missing Wasm export: __lsan_enable");
    ...
    ___lsan_disable = wasmExports2["__lsan_disable"];
    ___lsan_enable = wasmExports2["__lsan_enable"];
  ...
  var wasmSourceMap;
  var wasmSourceMapFile = locateFile("emscripten-module.wasm.map");
  ...
  async function getSourceMapAsync() {
    if (ENVIRONMENT_IS_WEB || ENVIRONMENT_IS_WORKER) {
      try {
        var response = await fetch(wasmSourceMapFile, { credentials: "same-origin" });
