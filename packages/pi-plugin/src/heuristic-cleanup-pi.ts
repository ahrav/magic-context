...
/**
 * Deduplicate only tools whose outputs are deterministic for identical inputs.
 * Mutating tools are excluded because identical calls can have position-dependent semantics.
 */
