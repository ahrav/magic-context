...
/// The negotiation request uses bootstrap consumer correlation 1; activation and commit use candidate correlations 1 and 2.
#[test]
...
async fn control_body_at_the_profile_cap_is_read_and_over_it_is_rejected_early() {
    ...
    // The host rejects the declared header length before receiving body bytes.
