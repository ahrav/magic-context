...
| Part | Scope | Status |
| --- | --- | --- |
| [part-1-shm-transport](part-1-shm-transport/) | `crates/mc-shm-transport`, `packages/mc-shm-native`; boundary context from `crates/mc-host/src/{shm_provider,transport_negotiation,transport_provider,provider_recovery}.rs` | 65 records; portfolio evaluated; all 7 queued gaps closed |
