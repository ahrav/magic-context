...
ITEMS: tuple[tuple[str, str], ...] = (
    ...
    ("SubcClient.request", "request(handle: RouteHandle, body: unknown, opts?: RequestOptions)"),
    ("SubcClient.call", "call<Response = unknown>(moduleId: string, method: string"),
    ("SubcClient.catalogList", "catalogList(moduleId?: string)"),
    ("SubcClient.closeRoute", "closeRoute(handle: RouteHandle, opts?: CloseRouteOptions)"),
    ...
    ("isConsumerReconnectTransient", "export declare function isConsumerReconnectTransient"),
